...
const MovieMetaData = ({ movie, backgroundColor, primaryFontColor, secondaryFontColor, active }) => {
  ...
  return (
    ...
    <Animatable.View 
      style={[styles.metaDataContainer, { borderBottomColor: primaryFontColor, borderTopColor: primaryFontColor, borderBottomWidth: 0.4, borderTopWidth: 0.4}]} 
      animation='fadeIn'
      duration={600}
      delay={300}
    >
      <View style={[ styles.movieMetaData, { display: active }]}>
        <View style={styles.movieRating}> 
          ...
          <Text allowFontScaling={false}  style={[styles.movieRatingUsers, {color: primaryFontColor}]}>Brugere ({movie.votes_count})</Text>
        </View>
        <View style={styles.movieRating}>
          ...
          <Text allowFontScaling={false} style={[styles.movieRatingUsers, {color: primaryFontColor}]}>Medier ({movie.media_rating_count})</Text>
        </View>
      </View>
  </Animatable.View>
